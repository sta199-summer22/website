...
output:
  xaringan::moon_reader:
    ...
    css: ["xaringan-themer.css", "introdsorg_slides.css"]
...
knitr::include_graphics("img/07/cholera.png")
```
...
knitr::include_graphics("img/07/nextstrain_WNV.png")
```
...
knitr::include_graphics("img/07/vector_raster_comparison.png")
```

The choice to use vector or raster data depends on the problem context. 
We will focus on vector data. <br>
.small[*Source:* https://commons.wikimedia.org/wiki/File:Raster_vector_tikz.png]
