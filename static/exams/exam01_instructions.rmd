...
The exam questions are in the README portion of your repository on [the GitHub course organization page](https://github.com/sta199-s22).

### Deadline

This exam is due Tuesday February 8th by 11:59 PM.
...
There will be a 5 percentage point (2.5 points) penalty for failing to submit a PDF to Gradescope.
...
-   The instructor will provide code debugging if needed, but this will
    result in a **grade penalty** if needed. Note: questions asked between 6:00pm and 11:59pm Tuesday the 8th may not be answered. 
