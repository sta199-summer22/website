...
subtitle: "due Monday, June 6 at 11:59pm"
output: 
  tufte::tufte_html:
    css: "./sta199-labs.css"
...
- Step 4: Visualize the null distribution with the rejection region shaded. Choose an informative label on the $x$-axis (e.g., sample proportion, sample median, etc.). Hint: use `visualize()` and `shade_pvalue()`. Compute p-value and compare to $\alpha = 0.05$. Write your conclusion.
