...
```{marginfigure}
Facet by the dataset variable, placing the plots in a 3 column grid, and don't add a legend. <br>
Notice that I moved `aes` to `geom_point()` from `ggplot()`. This will be useful later when we have multiple geom's. 
```
