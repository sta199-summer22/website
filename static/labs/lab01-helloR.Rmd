...
subtitle: "due Monday January 17 at 11:59 PM "
output: 
  tufte::tufte_html:
   #css: "./sta199-labs.css"
...
- Click to go to the [course GitHub organization page](https://github.com/sta199-s22).

- Select the repository entitled "lab01-GitHubUsername"
...
![How to Clone using SSH in GitHub](img/GitHub1.png)
...
![Version Control and Cloning Repo](img/Clone1.png)
...
```{r name, eval=FALSE}
git config --global user.name 'athos00'
git config --global user.email ‘alexander.fisher@duke.edu’
```

- Note: you will need to enter the quotes manually around the email (copy and pasting the code chunk directly above won't work)

## R and R Studio

![These are the general components of a R Markdown File](img/Rstudio1.png)


![These are the general components of a R Project](img/Rstudio2.png)
...
```` ```{r ex2-chunk-name, fig.height = 4, fig.width = 4} ````
