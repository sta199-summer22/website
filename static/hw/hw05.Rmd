...
subtitle: 'due Friday April 15 11:59 PM '
output:
  tufte::tufte_html:
...
-   Go to the [ORG](https://github.com/sta199-s22) organization on GitHub. Click on the repo with the prefix hw05. It contains the starter documents you need to complete the assignment.
...
- Your task is to make this plot as ugly as possible. Change each of the following: colors, axes, fonts, theme, and anything else you can think of. You can also search online for other themes, fonts, etc. that you want to tweak. Try to make it as ugly as possible, the sky is the limit!
