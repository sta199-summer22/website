...
subtitle: 'due October 30 11:59 PM '
output:
  tufte::tufte_html:
...
- Go to the [ORG](https://github.com/sta199-f21) organization on GitHub. Click on the repo with the prefix hw04. It contains the starter documents you need to complete the assignment.
...
where $p_{H}$ is the proportion of healthy adults how have "low" average vocal fundamental frequency and $p_{PD}$ is the proportion of adults with Parkinson's Disease who have "low" average vocal fundamental frequency. 
