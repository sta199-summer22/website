...
**Q - ** Apply CLT and write the distribution of $\bar{X}$ using mathematical notation. Describe its distribution in terms of the shape, center, and spread. Is is an approximate distribution or an exact distribution?
