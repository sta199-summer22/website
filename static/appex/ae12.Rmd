...
- read and decipher common mathematical notation, including **X**, and the difference between $\hat{p}$ and $p$.
- be able to define **null hypothesis**, **alternative hypothesis**, **statistic**, **likelihood**, **data-generative model**, **distribution**
- simulate samples from a binomial distribution
