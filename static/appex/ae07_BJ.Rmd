...
```{r plot-nc, fig.width=10, fig.height=4}
covid_sf %>% 
...
```{r plot-theme, fig.width=10, fig.height=4}
covid_sf %>% 
  filter(state == "North Carolina") %>% 
  ggplot() + 
  geom_sf() + 
...
```{r plot-covid-us, fig.width=10, fig.height=6}
covid_sf %>% 
  filter(date == "2022-05-05") %>% 
  ggplot() + 
...
```{r plot-covid-us-2, fig.width=10, fig.height=6}
covid_sf %>% 
  filter(date == "2022-05-05") %>% 
  ggplot() + 
...
```{r find-medium, include = FALSE}
covid_sf %>% 
  filter(date == "2022-05-05", 
         state == "North Carolina", 
         covid_community_level == "Medium")
```
...
```{r plot-covid-us-facet, out.width="100%", include = FALSE}
covid_sf %>% 
  ggplot() + 
  geom_sf(aes(fill = covid_community_level), 
          color = NA) + 
  facet_wrap(~ date) + 
  labs(title = "Covid-19 community level across US counties since Feb 2022", 
       fill = "Covid-19 community level") +
  scale_fill_manual(values = c("High" = "#fb8b5b",
                               "Medium" = "#f9f99d", 
                               "Low" = "#00cc99"))
...
```{r plot-covid-nc-facet, out.width="100%", include = FALSE}
covid_sf %>% 
  filter(state == "North Carolina") %>% 
  ggplot() + 
  geom_sf(aes(fill = covid_community_level)) + 
  facet_wrap(~ date) + 
  labs(title = "Covid-19 community level across NC counties since Feb 2022", 
       fill = "Covid-19 community level") +
  scale_fill_manual(values = c("High" = "#fb8b5b",
                               "Medium" = "#f9f99d", 
                               "Low" = "#00cc99"))
...
```{r plot-covid-ny-facet, out.width="100%", include = FALSE}
covid_sf %>% 
