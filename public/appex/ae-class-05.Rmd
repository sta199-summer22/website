...
- Quiz 2 due next Tuesday (The 14th)
- HW \#1 will be released Thursday
- Due today:
  - Lab 2
- Due Thursday:
  - prep videos
- Last time: visualizing data with `ggplot2`
...
To demonstrate data wrangling we will use a dataset of characteristics of flights departing from New York City (JFK, LGA, EWR) in 2013. 

We'll work with a small smaple (5000 flights) by loading in a CSV file of the data.

Feel free to play with the full dataset `flights` found within the `nycflights13` package outside of class.
...
**Question:** Can you print the first five rows and all columns of the 
...
**Question:** Does pipe order matter?
