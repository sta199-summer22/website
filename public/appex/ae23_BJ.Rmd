...
subtitle: "due Wednesday, June 15 at 9:29am"
author: "Bora Jin"
editor_options:
...
- Clone the repository entitled "ae23-GitHubUsername" at [course GitHub organization page](https://github.com/sta199-summer22) on your [RStudio](https://vm-manage.oit.duke.edu/containers).
...
Visualize the fitted line on a scatterplot using `geom_smooth()`. 
...
$$ p = \frac{1}{1+\exp\{-(\beta_0 + \beta_1x_1 + \cdots + \beta_kx_k)\}} = \frac{\exp(\beta_0 + \beta_1x_1 + \cdots + \beta_kx_k)}{1+\exp(\beta_0 + \beta_1x_1 + \cdots + \beta_kx_k)}$$ 
...
**Q - ** Interpret the estimated coefficients in context of data. Hint: Use the term "log odds". 
