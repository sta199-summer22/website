...
This graph leads readers overlook the population size affected by the deprivation level. It only considers the geographic size based on the traditional map. 
...
**Simpson's paradox** is a phenomenon where conclusions drawn from analyzing subgroups differ from conclusions drawn from the aggregate group. Can you demonstrate Simpson's paradox with the data below? ^[Source:  https://www.randomservices.org/random/data/Berkeley.html]
...
**Q - ** You want to make the data available so your analysis is transparent and reproducible. How can you modify the full data set to make the data available in an ethical way?
