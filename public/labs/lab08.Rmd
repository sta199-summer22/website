...
The data for this exam is from the [Ultra Trail Running data set featured in Tidy Tuesday](https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-10-26/readme.md) You can find the codebook with variable definitions in the Tidy Tuesday repo.
