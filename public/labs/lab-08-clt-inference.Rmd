...
subtitle: "due Friday, November 05 at 11:59pm"
output: 
  tufte::tufte_html:
 #   css: "sta199-labs.css"
...
- Go to the [sta199-f21](https://github.com/sta199-f21) course organization on GitHub.
...
where $\bar{x}$ is the sample mean, $\mu_0$ is the mean under the null, $s$ is the sample variance and $n$ is the sample size.

  - Explain what this value means in the context of this analysis. Refer to [sliders here](https://sta199-f21-001.netlify.app/slides/clt-inference.html#32) from the preparation for last class if necessary.
