...
-   Go to the [course organization page](https://github.com/sta199-f21) on GitHub.
...
**Step 4: Member 3** Write some narrative in the space provided. Commit and Push. You
should get an error.
...
Click to pull. *Then, knit, commit, and push.* All errors
