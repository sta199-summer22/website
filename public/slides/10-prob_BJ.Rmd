...
- Entire group we would like to make conclusions about 
...
- The group we have collected data from 
- Usually we have to settle with a sample because the population is just too big! 
...
- $A^c$ (A complement) is the event that $A$ is not true; a student in STA199 is in a different year than 2nd. 
...
- Interpretations 
  ...
  - Degree of belief an event will happen
...
- Homework 01 due today at 11:59pm
