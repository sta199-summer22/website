...
- **Homework (55%)**
  - Five individual homework assignments, Due Saturday
  
- **Labs (15%)** 
  - Individual assignments focusing on computational skills, Due Monday
  
- **Final Project (20%)**
  - Team project
  - Presentation during class on **June 22** and Final report by **June 23**. 
...
- For homework and lab assignments, there will be **20% deduction** for each 24-hour period the
assignment is late.

- Late work will **not** be accepted for AEs or the final project.
...
- Watch videos for [Prepare: Week 01](https://sta199-summer22.netlify.app/prepare/week01_may12_BJ.html)
